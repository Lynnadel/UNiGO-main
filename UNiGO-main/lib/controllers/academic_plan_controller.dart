...
class AcademicPlanController extends ChangeNotifier {
  ...
  final List<PlanSection> planSections = [
    ...
    PlanSection(
      ...
      indicatorColor: const Color.fromARGB(255, 255, 169, 82),
    ),
    PlanSection(
    ...
    PlanSection(
      ...
      indicatorColor: const Color.fromARGB(255, 28, 242, 114),
    ),
    PlanSection(
      title: 'Obligatory Speciality Courses',
      type: 'Obligatory Speciality Courses',
      indicatorColor: const Color.fromARGB(255, 82, 122, 255),
    ),
    PlanSection(
      title: 'Elective Speciality Courses',
      type: 'Elective Speciality Courses',
      indicatorColor: const Color.fromARGB(255, 255, 82, 232),
    ),
  ];
  ...
  Future<void> loadSections() async {
    ...
    try {
      ...
      //fallback: users/{uid}.courseGrades
