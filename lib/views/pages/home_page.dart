    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, visible, _) {
        ...
        if (gpaNum == null) {
          ...
          gpaColor = Colors.redAccent.withValues(alpha: 0.9);
        } else if (gpaNum < 2.5) {
          gpaColor = const Color.fromARGB(255, 253, 152, 19).withValues(alpha: 0.9);
        } else if (gpaNum < 3.0) {
          gpaColor = Colors.amber.withValues(alpha: 0.9);
        } else if (gpaNum < 3.65) {
          gpaColor = Colors.lightGreen.withValues(alpha: 0.9);
        } else {
          gpaColor = Colors.green.withValues(alpha: 0.9);
        }
